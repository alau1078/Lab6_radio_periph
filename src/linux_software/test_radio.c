...
void print_benchmark(volatile unsigned int *periph_base)
{
	...
	printf("Time start %u: \r\n", start_time);
	printf("Now reading 32-bit (4 bytes) timer 2048 times\r\n");
    ...
    float time_spent = (stop_time-start_time)/(125000000.0); // change obviously
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Anthony Lau - Custom Peripheral Demonstration\n\r");
